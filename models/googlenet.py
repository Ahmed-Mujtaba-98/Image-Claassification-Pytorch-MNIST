...
class GoogLeNet(nn.Module):
   ...
   def __init__(self, input_channels=1, num_classes=10): # Change input_channels to 1 for grayscale images
       """
       ...
       self.avgpool = nn.AvgPool2d(7, stride=1) # Adjusted the kernel size to match the smaller input size
